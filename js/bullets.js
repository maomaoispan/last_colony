...
var bullets = {
    ...
    defaults: {
        ...
        moveTo: function (destination) {
            // Weapons like the heatseeker can turn slowly toward while moveing
            if (this.turnSpeed) {
            ...
            var angleRadius = -((this.direction / this.directions) * 2 * Math.PI);
        ...
        processOrders: function () {
            ...
            switch (this.orders.type) {
                case "fire":
                    // Move to destination and stop when close by or if travelled past range
            ...
            switch (this.action) {
                ...
                case "explode":
                    ...
                    if (this.animationIndex >= this.imageList.count) {
                        // Bullet explodes completely and the disappears
                        game.remove(this);
                    }
                    break;
            }

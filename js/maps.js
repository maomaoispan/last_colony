...
var maps = {
    "singleplayer": [
        ...
        {
            "name": "初战",
            "briefing": "在这一关你将学习怎么去控制游戏精灵，包括移动，攻击等。",

            /* Map Details */

            "mapImage": "images/maps/level-1.png",
            "map_Brief": "images/maps/level-1-brief.png",
            "startX": 4,
            "startY": 4,
            ...
            "requirements": {
                "buildings": ["base", "starport", "harvester", "ground-turret", "ground-radar"],
...
//                {"type": "buildings", "name": "ground-radar", "x": 25, "y": 14, "team": "blue"},
...
//                {"type": "buildings", "name": "ground-radar", "x": 20, "y": 34, "team": "green"}
            ...
            "triggers": [
                ...
                {"type": "timed",
                    ...
                    "action": function () {
                        game.sendCommand([-1],
                            {type: "construct-unit", details: {type: "aircraft", name: "wraith",
                ...
                {"type": "timed",
                    ...
                    "action": function () {
                        game.sendCommand([-1],
                            {type: "construct-unit", details: {type: "aircraft", name: "chopper",
                ...
                {"type": "timed",
                    ...
                    "action": function () {
                        game.sendCommand([-1],
                            {type: "construct-unit", details: {type: "vehicles", name: "heavy-tank",
                                orders: {"type": "patrol", "from": {"x": 15, "y": 30}, "to": {"x": 22, "y": 21}}}});
                    }
                },
                {"type": "timed",
                    ...
                    "action": function () {
                        game.sendCommand([-1],
                            {type: "construct-unit", details: {type: "vehicles", name: "scout-tank",
                                orders: {"type": "patrol", "from": {"x": 22, "y": 30}, "to": {"x": 15, "y": 21}}}});
                    }
                },
                {"type": "timed",
                    "time": 30000,
                    "action": function () {
                        game.showMessage("AI", "Now every enemy unit is going to attack you in a wave.<br><br>嗨，现在所有敌人要紧进行一次全面攻击。");
                        var units = [];
                        for (var i = 0; i < game.items.length; i++) {
                            var item = game.items[i];
                            if (item.team == "green"
                                && (item.type == "vehicles" || item.type == "aircraft")) {
                                units.push(item.uid);
                            }
                        }
...
//                                success += 1;
//                            } else if (item.team && (item.team != game.team)) {
//                                enemy += 1;
//                            }
//                        }
//                        return(success > 0 && enemy == 0);
//                    },
//                    "action": function () {
...
//                }
        ...
        {
            "name": "黎明之光",
            "briefing": "黎明之光，你已经不再是一个新手了，你将有更重要的任务去完成。",

            /* Map Details */

            "mapImage": "images/maps/level-2.png",
            "map_Brief": "images/maps/level-2-brief.png",
            "startX": 4,
            "startY": 4,
...
//                }
        ...
        {
            "name": "第三关",
            "briefing": "第三关，你已经不再是一个新手了，你将有更重要的任务去完成。",

            /* Map Details */

            "mapImage": "images/maps/level-3.png",
            "map_Brief": "images/maps/level-3-brief.png",
            "startX": 4,
            "startY": 4,
...
//                {"type": "buildings", "name": "ground-radar", "x": 20, "y": 34, "team": "green"}
        ...
        {
            "name": "第四关",
            "briefing": "第四关，你已经不再是一个新手了，你将有更重要的任务去完成。",

            /* Map Details */

            "mapImage": "images/maps/level-4.png",
            "map_Brief": "images/maps/level-4-brief.png",
            "startX": 4,
            "startY": 4,
...
//                {"type": "buildings", "name": "ground-radar", "x": 20, "y": 34, "team": "green"}
        ...
        {
            "name": "第五关",
            "briefing": "第五关，你已经不再是一个新手了，你将有更重要的任务去完成。",

            /* Map Details */

            "mapImage": "images/maps/level-5.png",
            "map_Brief": "images/maps/level-5-brief.png",
            "startX": 4,
            "startY": 4,
...
//                {"type": "buildings", "name": "ground-radar", "x": 20, "y": 34, "team": "green"}
    ...
    "multiplayer": [
        //第一关
        {
            ...
            /* Conditional and Timed Trigger Events */
            "triggers": [
                /* Lose if not even one Trigger Events */
                {"type": "conditional",
                    "condition": function () {
                        for (var i = 0; i < game.items.length; i++) {
